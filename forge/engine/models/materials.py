...
# Cost rates [EUR/g] — placeholder values from constants.py
COST_ANODE_COATING = 0.01
COST_ANODE_COLLECTOR = 0.015
COST_CATHODE_COATING = 0.02
COST_CATHODE_COLLECTOR = 0.002
COST_SEPARATOR = 0.18
COST_ELECTROLYTE = 0.019
COST_TAB_COPPER = 0.01
COST_TAB_ALUMINUM = 0.005
COST_HOUSING_POUCH = 0.01
