#!/usr/bin/env python3
"""
Corpus B Cloud Experiment Runner.

Runs one cloud model × one condition over the 250-prompt Corpus B.

Usage:
    .venv/bin/python3 forge/experiments/corpus_b/run_corpus_b_cloud.py \
        --model haiku --condition unsup
"""
...
def main():
    parser = argparse.ArgumentParser(description="Corpus B cloud experiment runner")
    ...
    experiment = ExperimentDefinition(
        ...
        description=f"Corpus B cloud evaluation: {backend_cfg.model}, {'supervised' if supervised else 'unsupervised'}",
